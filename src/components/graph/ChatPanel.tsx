...
const shellStyle: React.CSSProperties = { animation: 'fadeUp 0.24s ease both', display: 'flex', flexDirection: 'column', height: '100%', background: '#080e1a', fontFamily: '"Inter","IBM Plex Sans","Segoe UI",system-ui,sans-serif', fontSize: 14, overflow: 'hidden' }
const userBubble: React.CSSProperties = { background: 'rgba(99,102,241,0.18)', border: '1px solid rgba(99,102,241,0.28)', borderRadius: '10px 10px 2px 10px', color: '#c7d2fe', fontSize: 13, lineHeight: 1.55, maxWidth: '85%', padding: '7px 11px', wordBreak: 'break-word' }
...
const suggStyle: React.CSSProperties = { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 6, color: '#64748b', cursor: 'pointer', display: 'block', fontSize: 12, fontFamily: 'inherit', lineHeight: 1.45, marginBottom: 5, padding: '7px 10px', textAlign: 'left', transition: 'background 0.12s,color 0.12s,border-color 0.12s,transform 0.12s', width: '100%' }
...
const inputStyle: React.CSSProperties = { background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 7, color: '#f1f5f9', flex: 1, fontSize: 13, fontFamily: 'inherit', outline: 'none', padding: '7px 10px', transition: 'border-color 0.15s,box-shadow 0.15s' }
...
const errorBox: React.CSSProperties = { alignItems: 'center', animation: 'errorPop 0.22s ease both', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 6, color: '#f87171', display: 'flex', fontSize: 12, gap: 8, padding: '6px 10px' }
